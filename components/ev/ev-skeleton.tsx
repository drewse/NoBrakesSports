...
/**
 * Layout-matching skeleton for the +EV / Top Lines page. Used by
 * both `app/(app)/top-lines/loading.tsx` (route transition) and the
 * page-level <Suspense> fallback. Shape mirrors EvCalculatorClient.
 */
export function EvSkeleton() {
  return (
