...
// specific one first.
// Must stay in sync with lib/pipelines/normalize.ts. Space-terminated
// prefixes only — bare forms mangle full names via startsWith and were
// the single source of the "boston" → "bostonton" duplicate-event bug.
