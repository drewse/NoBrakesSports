...
const USA_BOOK_TRACKER: UsaBookEntry[] = [
  ...
  { name: 'Prophet Exchange',    slug: 'prophet-exchange',   operator: 'Prophet Sports Exchange',         url: 'https://www.prophetx.co',            platform: 'REST + Pusher WebSockets',   category: 'exchange', states: ['IN','NJ','OH'], status: 'in_progress', notes: 'Real app is at prophetx.co (prophetexchange.com was Framer marketing). REST endpoints (/api/v1/*, /trade/public/api/v1/*) carry config + static ladder constants; live prices stream over Pusher WS (cluster mt1, app_id 1810913). Discovery adapter captures WS frames; needs Pusher subscriber pattern for live data.' },
