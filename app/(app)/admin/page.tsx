...
const CA_BOOK_TRACKER: CaBookEntry[] = [
  ...
  { name: 'Caesars',       slug: 'caesars',      platform: 'Liberty',       difficulty: 'hard',   status: 'blocked',     deployedTo: 'railway', gameLevel: false, props: false, frequency: null,     notes: 'AWS WAF 403 direct, ERR_EMPTY_RESPONSE via PacketStream. Parked (CAESARS_ENABLED=0). Needs CA residential proxy.' },
  { name: 'BetVictor',     slug: 'betvictor',    platform: 'Proprietary',   difficulty: 'medium', status: 'blocked',     deployedTo: 'railway', gameLevel: false, props: false, frequency: null,     notes: 'Geo-blocks Railway US IP. /bv_api/* returns empty arrays. Parked (BETVICTOR_ENABLED=0). Might work from CA VPS.' },
  ...
  // ── Discovery mode (adapter loads, no parser written yet) ─────────────
  { name: 'theScore Bet',  slug: 'thescore',     platform: 'Penn (Next.js)', difficulty: 'hard',  status: 'in_progress', deployedTo: 'railway', gameLevel: false, props: false, frequency: null,     notes: 'Discovery captures Next.js chunks only; GraphQL persisted query not firing. Needs DevTools curl.' },
  { name: 'Proline (OLG)', slug: 'proline',      platform: 'OLG custom',    difficulty: 'hard',   status: 'in_progress', deployedTo: 'railway', gameLevel: false, props: false, frequency: null,     notes: 'Discovery captures olg.ca JS/i18n. SPA does not initialize under proxy.' },
  { name: 'Betano',        slug: 'betano',       platform: 'Kaizen',        difficulty: 'medium', status: 'in_progress', deployedTo: 'railway', gameLevel: false, props: false, frequency: null,     notes: 'Discovery captures /api/kb-config, /api/v1/translations. Needs deeper seed.' },
  { name: 'Casumo',        slug: 'casumo',       platform: 'Unknown',       difficulty: 'medium', status: 'in_progress', deployedTo: 'railway', gameLevel: false, props: false, frequency: null,     notes: 'Discovery captures spine-api/static-blocks layout only. CA sportsbook may be on different host.' },
  { name: 'Bally Bet',     slug: 'ballybet',     platform: 'Bragg',         difficulty: 'hard',   status: 'in_progress', deployedTo: 'railway', gameLevel: false, props: false, frequency: null,     notes: 'Discovery captures play.ballybet.ca harness + i18n. Sportsbook SPA not initializing through proxy.' },
