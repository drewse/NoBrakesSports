...
const USA_BOOK_TRACKER: UsaBookEntry[] = [
  ...
  { name: 'BetParx',             slug: 'betparx',            operator: 'Parx Casino',                     url: 'https://betparx.com',                platform: 'Kambi',                      category: 'regional', states: ['IL','MD','NJ','OH','PA'],                  status: 'blocked', notes: 'Attempted via Vercel cron (kambi-props.ts). Host confirmed eu-offering-api.kambicdn.com (same as CA ops), but every listView call to /parx/ returns HTTP 429 from Vercel\'s shared serverless IP pool — even with Origin/Referer=https://www.betparx.com, market=US-PA, browser UA. CA operators get 200 from same IPs → client-specific rate limit. Parked in KAMBI_OPERATORS (commented out). Revisit via Railway mobile proxy or session-init flow from play.betparx.com.' },
