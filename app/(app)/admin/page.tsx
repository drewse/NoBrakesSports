...
const USA_BOOK_TRACKER: UsaBookEntry[] = [
  ...
  { name: 'BetParx',             slug: 'betparx',            operator: 'Parx Casino',                     url: 'https://betparx.com',                platform: 'Kambi',                      category: 'regional', states: ['IL','MD','NJ','OH','PA'],                  status: 'in_progress', notes: 'Vercel direct fetch hit 429 on every listView (client-specific rate limit). Re-enabled with proxied=true — fetches now route through PacketStream residential (PROXY_URL) via pipeFetch. Origin=https://www.betparx.com, market=US-PA, en_US. Awaiting next cycle to confirm residential IPs clear the rate limit.' },
