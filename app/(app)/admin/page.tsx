...
const CA_BOOK_TRACKER: CaBookEntry[] = [
  ...
  { name: 'Casumo',        slug: 'casumo',       platform: 'N/A',           difficulty: 'easy',   status: 'dead',        deployedTo: 'unknown', gameLevel: false, props: false, frequency: null,     notes: 'Casumo CA has no sportsbook product — confirmed. Remove from worker.' },
