...
const USA_BOOK_TRACKER: UsaBookEntry[] = [
  ...
  { name: 'BetParx',             slug: 'betparx',            operator: 'Parx Casino',                     url: 'https://betparx.com',                platform: 'Kambi',                      category: 'regional', states: ['IL','MD','NJ','OH','PA'],                  status: 'in_progress', notes: 'Added as a Kambi operator in kambi-props.ts (client=parx, host=c3.sb.kambicdn.com, lang=en_US, market=US-PA). Awaiting first sync-props fire to confirm events + odds flow. Will auto-create market_sources row on success.' },
