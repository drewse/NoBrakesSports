...
const USA_BOOK_TRACKER: UsaBookEntry[] = [
  ...
  { name: 'Underdog Fantasy',    slug: 'underdog',           operator: 'Underdog Sports',                 url: 'https://underdogfantasy.com',        platform: 'DFS pick-em',                category: 'dfs-sweepstakes', states: ['AK','CA','DC','FL','GA','IL','IN','KS','KY','MN','NC','ND','NE','NM','OK','OR','RI','SC','SD','TX','UT','WI'], status: 'in_progress', notes: 'Vercel cron adapter shipped (lib/pipelines/adapters/underdog-props.ts). Single endpoint /beta/v5/over_under_lines (16MB) covers all sports; filter to NBA/MLB/NHL/NFL/WNBA via player.sport_id. Unlike PrizePicks, quotes real american_price per higher/lower option — Model B, real odds go into prop_odds. Team names come from game.full_team_names_title "Away @ Home". Awaiting first production fire.' },
