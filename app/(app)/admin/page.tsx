...
const USA_BOOK_TRACKER: UsaBookEntry[] = [
  ...
  { name: 'Bovada',              slug: 'bovada',             operator: 'Harp Media B.V.',                 url: 'https://www.bovada.lv',              platform: 'Proprietary',                category: 'offshore', states: ['ALL'], status: 'in_progress', notes: 'Standalone cron /api/cron/sync-bovada every 5 min (+3 offset). Public JSON endpoint /services/sports/event/coupon/events/A/description/{sport}/{league} returns events with moneyline/spread/total in a Game Lines displayGroup. Matches canonical events by sorted team-pair + day; does NOT auto-create.' },
