...
const NO_PROXY_LIVE: BookEntry[] = [
  ...
  // ── Books unlocked by adding uk + au regions to The Odds API ──────
  { name: 'Sky Bet',            note: 'UK · The Odds API uk region · sync-odds cron · 2h' },
  { name: 'Paddy Power',        note: 'UK · The Odds API uk region · sync-odds cron · 2h' },
  { name: 'Coral',              note: 'UK · The Odds API uk region · sync-odds cron · 2h' },
  { name: 'Ladbrokes UK',       note: 'UK · The Odds API uk region · sync-odds cron · 2h' },
  { name: 'William Hill UK',    note: 'UK · The Odds API uk region · sync-odds cron · 2h' },
  { name: 'Matchbook',          note: 'UK exchange · The Odds API uk region · sync-odds cron · 2h' },
  { name: 'Betfair Exchange UK', note: 'UK exchange · The Odds API uk region · sync-odds cron · 2h' },
  { name: 'Sportsbet',          note: 'AU · The Odds API au region · sync-odds cron · 2h' },
  { name: 'TAB',                note: 'AU · The Odds API au region · sync-odds cron · 2h' },
  { name: 'Neds',               note: 'AU · The Odds API au region · sync-odds cron · 2h' },
  { name: 'Ladbrokes AU',       note: 'AU · The Odds API au region · sync-odds cron · 2h' },
  { name: 'Betfair Exchange AU', note: 'AU exchange · The Odds API au region · sync-odds cron · 2h' },
  // Railway direct-IP
